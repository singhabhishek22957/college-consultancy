...
import { archiveUniversity } from '../../Service/UniversityService.jsx';
import LoadingPopUp from '../User/LoadingPopUp.jsx';
import MessagePopUp from '../MessagePopUp.jsx';

const SendArchiveUniversity = ({ isArchive, universityId, universityName }) => {
  ...
  useEffect(() => {
    const archive = async () => {
      ...
      try {
        ...
        setLoading(true);
        const response = await archiveUniversity({
...
export default SendArchiveUniversity;
